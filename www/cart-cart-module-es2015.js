        ...
        this.api.checkAuth().then((user) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (user) {
                ...
                if (id) {
                    ...
                    const foods = yield localStorage.getItem('foods');
                    if (foods) {
                        this.foods = yield JSON.parse(foods);
                        let recheck = yield this.foods.filter(x => x.quantiy > 0);
